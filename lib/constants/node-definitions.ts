...
export const NODE_DEFINITIONS: NodeDefinition[] = [
  ...
  // ═══ TOOLBOX — EDITING (10) ═══════════════════════════════════════════════
  {
    ...
    inputs: [imgR('Image')], outputs: [img('Image')], status: 'soon',
  },
  {
    ...
    inputs: [{ name: 'Images', type: 'image', multiple: true, required: true }], outputs: [img('Image')], status: 'soon',
  },
  {
  ...
  },
  {
    ...
    inputs: [vidR('Video')], outputs: [img('Frame')], status: 'soon',
  },
  {
  ...
  },
  {
    ...
    inputs: [imgR('Image'), mskR('Mask')], outputs: [img('Image')], status: 'soon',
  },
  {
    id: 'videoMatteNode', label: 'Video Matte', icon: '🎬',
    description: 'Video için otomatik maske çıkarma',
    category: 'toolbox-matte', subcategory: 'mask',
    inputs: [vidR('Video')], outputs: [vid('Matte')], status: 'soon',
  },
  {
  ...
  },
  {
    ...
    category: 'image-i2i', subcategory: 'controlnet',
    inputs: [imgR('Image'), txtR('Prompt')], outputs: [img('Image')],
    provider: 'Stability AI', creditCost: 10, status: 'soon',
  },
  {
  ...
  },
  {
    ...
    category: 'community', subcategory: 'control',
    inputs: [imgR('Image'), txtR('Prompt')], outputs: [img('Image')],
    provider: 'Black Forest Labs', creditCost: 10, status: 'soon',
  },
  {
    ...
    inputs: [vidR('Video'), aud('Audio')], outputs: [vid('Video')],
    provider: 'Kuaishou', creditCost: 15, status: 'soon',
  },
  {
