...
export const nodeTypes = {
  ...
  // Community — still soon (need specific API / client implementation)
  ...
  // Community nodes — Faz A-3
  dreamshaperNode: CommunityNodeContent,
  dreamshaperV8Node: CommunityNodeContent,
  sdxlLightning4StepNode: CommunityNodeContent,
  realisticVisionNode: CommunityNodeContent,
  sd3ExplorerNode: CommunityNodeContent,
  dynavisionNode: CommunityNodeContent,
  sd3ControlNetsNode: CommunityNodeContent,
  ipAdapterSdxlNode: CommunityNodeContent,
  sdxlControlNetNode: CommunityNodeContent,
  controlLcmNode: CommunityNodeContent,
  sdxlConsistentCharNode: CommunityNodeContent,
  sdxlMultiControlNetLoraNode: CommunityNodeContent,
  xlabsFluxDevNode: CommunityNodeContent,
  fluxReduxControlNetNode: CommunityNodeContent,
  idPreservationFluxNode: CommunityNodeContent,
  realEsrganUpscaleNode: CommunityNodeContent,
  recraftCreativeUpscaleNode: CommunityNodeContent,
  clarityUpscaleNode: CommunityNodeContent,
  ultimateSdUpscaleNode: CommunityNodeContent,
  faceAlignNode: CommunityNodeContent,
  zDepthExtractorNode: CommunityNodeContent,
  expressionEditorNode: CommunityNodeContent,
  gfpganVideoNode: CommunityNodeContent,
  faceSwapNode: CommunityNodeContent,
  animatedDiffNode: CommunityNodeContent,
  wan21WithLoraNode: CommunityNodeContent,
  wan211Vid2VidNode: CommunityNodeContent,
  tooncrafterNode: CommunityNodeContent,
  robustVideoMattingNode: CommunityNodeContent,
