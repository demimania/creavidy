...
export const BentoGridItem = ({
    ...
    return (
        <Spotlight className={cn(
            ...
            {/* Inner border glow for extra cosmos feel */}
            <div className="absolute inset-0 rounded-xl ring-1 ring-inset ring-white/10 group-hover/bento:ring-white/20 transition-all pointer-events-none" />
        </Spotlight>
    );
};
